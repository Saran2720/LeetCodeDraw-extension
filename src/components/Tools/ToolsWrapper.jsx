...
const ToolsWrapper = () => {
  ...
  return (
    <div className="fixed top-10 right-4 flex flex-col items-center gap-3 p-2 bg-stone-800 dark:text-white rounded-xl shadow-lg z-50">
      ...
      {showPenTool && (
        <PenTool onClose={() => setShowPenTool(false)} parentRef={penButtonRef} />
      )}
